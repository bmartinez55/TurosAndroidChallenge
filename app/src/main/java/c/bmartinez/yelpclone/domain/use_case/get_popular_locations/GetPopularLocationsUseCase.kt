package c.bmartinez.yelpclone.domain.use_case.get_popular_locations
...
class GetPopularLocationsUseCase @Inject constructor(
    ...
    operator fun invoke(latitude: Double, longitude: Double): Flow<Resource<BusinessSearch>> = flow {
        try {
            emit(Resource.Loading())
            val businesses = businessRepository.getPopularLocations(latitude, longitude).toBusinessSearch()
